...
export default function SyllabusUploadScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={styles.header} entering={FadeInDown.delay(100).duration(600)}>
        ...
        <Text style={styles.subtitle}>Let us extract your subjects and calculate their weightage automatically.</Text>
      </Animated.View>
