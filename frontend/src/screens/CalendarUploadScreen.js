  ...
  return (
    <View style={styles.container}>
          ...
          >
            ...
            >
              {loading ? (
                ...
                <>
                  <MaterialCommunityIcons name="calendar-month" size={64} color={COLORS.textPrimary} style={{ marginBottom: SPACING.md }} />
      ...
      <Animated.View entering={FadeInUp.delay(500).duration(600)} style={styles.footer}>
        <TouchableOpacity style={styles.manualButton} onPress={() => navigation.navigate('CalendarCorrection', { parsedCalendar: [] })}>
